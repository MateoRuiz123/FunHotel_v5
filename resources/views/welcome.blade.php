...
<div class="texto">
    <p>Funhotel surge de la necesidad que se presentaba con los estudiantes de Hotelería Y Turismo, de contar con una
        herramienta eficiente y accesible, ante la falta de recursos que pudieran completar su formación, un grupo de
        entusiastas estudiantes, decidieron emprender un emocionante proyecto.
        <br>
        Así nació FunHotel, un innovador aplicativo, creado con la misión de optimizar y facilitar el proceso de
        aprendizaje para los estudiantes de Hotelería Y Turismo.
    </p>
</div>
</div>
    ...
    <div class="card">
        ...
        <div class="contenido-card">
            ...
            <p>Nos esforzamos por ser un referente en la industria hotelera, ofreciendo un
                servicio excepcional y experiencias inigualables.</p>
        </div>
    </div>
    <div class="card">
        <figure>
...
<footer>
    <p>&copy; 2023 FunHotel. Elevando el arte de la hospitalidad con innovación y pasión. Todos los derechos reservados.
    </p>
</footer>
</body>
